        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditCardCSV = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OdometerRead = table.Column<int>(type: "int", nullable: false),
                    PricePerHour = table.Column<float>(type: "real", nullable: false),
                    Deposit = table.Column<float>(type: "real", nullable: false),
                    OverduePricePerHour = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HadBooking = table.Column<bool>(type: "bit", nullable: false),
                    OverdueTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReturnedLate = table.Column<bool>(type: "bit", nullable: false),
                    VehicleDamaged = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalPayable = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OverduePayable = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DamagesPayable = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_Rental_RentalId",
                        column: x => x.RentalId,
